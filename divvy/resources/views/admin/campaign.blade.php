    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-8">
          ...
          <div class="row">
            <div class="col-md-12">
              <p class="lead mt-4">{{$cam->Campaign_Details}}</p>
            </div>
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="row pt-4">
            ...
            <div class="col-md-8">
              <div class="row">
                <div class="col-md-4"><a class="btn btn-primary text-white" onclick="window.location='{{route('adminCampaignAll')}}'" style="">Back&gt;</a></div>
                @if($cam->Campaign_Status === 'Open')
                <div class="col-md-4"><a class="btn btn-danger text-white" onclick="window.location='{{route('adminCampaignCancel')}}?id={{$cam->ID}}'" style="">Cancel&gt;</a></div>
                <div class="col-md-4"><a class="btn btn-success text-white" onclick="window.location='{{route('adminCampaignClose')}}?id={{$cam->ID}}'" style="">Close&gt;</a></div>
                @endif
              </div>
            </div>
