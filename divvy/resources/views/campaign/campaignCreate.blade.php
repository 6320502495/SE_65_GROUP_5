<form action="{{route('campaignSave')}}" method="POST">
    @csrf
    ...
    <textarea id="Campaign_Details" name="Campaign_Details" required></textarea>
  
    <label for="Campaign">Campaign Tel:</label>
    <input type="text" id="Campaign_Tel" name="Campaign_Tel" required>
  
    <label for="Campaign">Campaign Bank ID:</label>
    <input type="text" id="Campaign_Bank_ID" name="Campaign_Bank_ID" required>
  
    <label for="Campaign">Campaign Bank Type:</label>
    <input type="text" id="Campaign_Bank_Type" name="Campaign_Bank_Type" required>
