      ...
      <div class="row">
        <div class="col-3">
          <ul class="nav nav-pills flex-column">
            ...
            <li class="nav-item"> <a class="nav-link" href="" data-toggle="pill" data-target="#tabtwo">Verify</a> </li>
...
200">
              <div class="row mt-4">
                ...
                <div class="col-md-6">
                  <p class="lead text-left">User123</p>
                </div>
              </div>
              <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                  <p class="lead text-left">uer123xbctj89</p>
                </div>
              </div>
              <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                  <p class="lead text-left">100.00</p>
                </div>
