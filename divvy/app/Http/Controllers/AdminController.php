...
class AdminController extends Controller
{
    ...
    public function showAllAccount()
    {
        $accounts = DB::table('users')
            ...
            ->select('users.id', 'verify_forms.image', 'users.name', 'verify_forms.firstname', 'verify_forms.lasName', 'verify_forms.birthDate', 'users.email', 'users.password', 'users.amount_user', 'users.ban_status')
