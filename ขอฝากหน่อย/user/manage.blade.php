                ...
                <table class="table">
                  ...
                  @foreach ($mycampaigns as $campaign)
                    <tr>
                      ...
                      @if($campaign->campaign_type=="Individual")<td>{{Auth::user()->name}}</td>
                      @elseif($campaign->campaign_type=="Organization")<td>{{$campaign->ins_name}}</td>                     
                      @endif

                      <td>{{$campaign->bank_ID}}</td>
                      
                      @if($campaign->campaign_type=="Individual")<td>{{$campaign->campaign_Tel}}</td>
                      @elseif($campaign->campaign_type=="Organization")<td>{{$campaign->ins_Tel}}</td>                     
                      @endif
