...
class UserController extends Controller
{
    ...
    //ของฟ้า
    /*public function addAmount(string $id, string $sumAmount, string $amount): View
    {
        $id_user =Auth::user()->id;
        return view('top_up.index',['top_ups' => Top_up::where('id', $id)->update(['status' => 'check']),
    ...
    public function reduceAmount(string $id, string $sumAmount, string $amount): View
    {
        $id_user =Auth::user()->id;
        return view('top_up.index', ['User' => User::where('id', $id_user)->update(['amount_user' => $sumAmount]),
    ...
    public function rejectT(string $id, string $amount): View
    {
        $id_user =Auth::user()->id;
        return view('top_up.index',['top_ups' => Top_up::where('id', $id)->update(['status' => 'check']),
    ...
    public function rejectW(string $id, string $amount): View
    {
        $id_user =Auth::user()->id;
        return view('top_up.index', ['withdraws' => Withdraw::where('id', $id)->update(['status' => 'check']),
